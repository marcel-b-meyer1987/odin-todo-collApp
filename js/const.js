...
export const UI_CONST = {
    ...
    MENU_ITEMS: [
        ...
        },
        {
            name: "trashBin",
            disp_name: {
                en: `${SYMBOLS.DELETE} Trash Bin`,
                de: `${SYMBOLS.DELETE} Papierkorb`,
            }
        },
        {
            name: "team",
